...
public class AjouterAtelierController {
    ...
    private void handleAjouter() {
        try {
            ...
            if (success) {
                ...
                // Redirect to the list of ateliers
    ...
    private void redirectToAtelierList() {
        try {
            ...
            stage.setTitle("Liste des Ateliers");
            stage.show();
        } catch (Exception e) {
            showAlert(Alert.AlertType.ERROR, "Erreur", "Impossible de rediriger vers la liste des ateliers : " + e.getMessage());
        }
    }
