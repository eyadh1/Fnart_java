...
public class UserService implements IService<User> {
    ...
    public boolean signUp(User user) {
        ...
        String insertQuery = "INSERT INTO user (nom, email, password, roles, phone, gender, status, image_path) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public List<User> searchUsers(String searchTerm) {
        ...
        //return getAll().stream().filter(e ->e.getEmail().contains(searchTerm.toLowerCase())).toList();
    }
